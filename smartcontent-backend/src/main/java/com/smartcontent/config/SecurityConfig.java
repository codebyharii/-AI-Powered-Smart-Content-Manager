...
import com.smartcontent.security.CustomUserDetailsService;
import com.smartcontent.security.JwtAuthenticationEntryPoint;
import com.smartcontent.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/ai/**").hasAnyRole("AUTHOR", "ADMIN")
